...
// API ROUTES
// ------------------------
app.get("https://wordle-answer-checker.onrender.com/api/used-words", (req, res) => {
    res.status(200).json(loadWords())
})

app.post("https://wordle-answer-checker.onrender.com/api/add-word", (req, res) => {
    const { word } = req.body
...
app.post("https://wordle-answer-checker.onrender.com/api/check-word", (req, res) => {
    const { word } = req.body
    try {
